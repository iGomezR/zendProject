...
//	    	$_schema = 'DBCONEX1';
        ...
        public function crearArch($_contenido, $_contenidoTab, $_nombre ){        	
 	      	$_carpetaTabla = 'C:\xampp\htdocs\carboneria\application\models\DbTable\ ';
                $_carpetaFilaTabla = 'C:\xampp\htdocs\carboneria\application\models\ ';
                //$_carpetaTabla = 'public_html/carboneria/application/models/DbTable/ ';
    		//$_carpetaFilaTabla = 'public_html/carboneria/application/models/ ';
