agrupamientoGrids = "";
primeraVez = true;
table = "/carboneria/public/index.php/administrativo/camion/";
campos = new Array('Proveedor', 'Marca','Modelo','Anho','Peso Neto','cod_proveedor','Chapa');
camposId = new Array('desc_proveedor', 'marca_camion','modelo_camion','anho_camion',
            'peso_neto_camion','cod_proveedor','chapa_camion');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
    ...
    parametros.marca_camion = rowObject[3];
    parametros.modelo_camion = rowObject[4];
    parametros.anho_camion = rowObject[5];
    parametros.peso_neto_camion = rowObject[6];
    parametros.cod_proveedor = rowObject[7];       
    parametros.chapa_camion = rowObject[8];  
