agrupamientoGrids = "";
primeraVez = true;
table = "/carboneria/public/index.php/administrativo/proveedor/";
campos = new Array('Sucursal', 'Proveedor','Ruc','Direccion','Telefono','cod_sucursal');
camposId = new Array('desc_sucursal', 'desc_proveedor','ruc_proveedor','direccion_proveedor','telefono_proveedor','cod_sucursal');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.desc_proveedor = rowObject[3];
	parametros.ruc_proveedor = rowObject[4];
	parametros.direccion_proveedor = rowObject[5];
        parametros.telefono_proveedor = rowObject[6];
