agrupamientoGrids = "";
primeraVez = true;
table = "/carboneria/public/index.php/administrativo/ordendeentrada/";
campos = new Array('Nro. Orden de Entrada','Proveedor', 'Camion','Chofer','Usuario Analista','Fecha',
                    'cod_proveedor','cod_camion','cod_chofer','cod_usuario_analista','Peso de Entrada');
camposId = new Array('nro_orden_de_entrada','desc_proveedor', 'desc_camion','nombre_chofer',
                    'desc_analista','fecha_registro',
                    'cod_proveedor','cod_camion','cod_chofer','cod_usuario_analista','peso_total');
...
{    
    ...
    parametros.cod_proveedor = rowObject[8];
    parametros.cod_camion = rowObject[9];
    parametros.cod_chofer = rowObject[10];
    parametros.cod_usuario_analista = rowObject[11];       
    parametros.nro_orden_de_entrada = rowObject[2];
    parametros.peso_total = rowObject[12]; 
