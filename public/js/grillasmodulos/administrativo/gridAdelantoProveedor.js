agrupamientoGrids = "";
primeraVez = true;
table = "/carboneria/public/index.php/administrativo/adelantoproveedor/";
campos = new Array('Proveedor', 'Fecha Adelanto','Monto','Estado','cod_proveedor');
camposId = new Array('desc_proveedor', 'fecha_adelanto','monto_adelanto','desc_estado_adelanto','cod_proveedor','estado_adelanto');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
    ...
    parametros.fecha_adelanto = rowObject[3];
    parametros.monto_adelanto = rowObject[4];
    parametros.desc_estado_adelanto = rowObject[5];
    parametros.cod_proveedor = rowObject[6];       
    parametros.estado_adelanto = rowObject[7];
