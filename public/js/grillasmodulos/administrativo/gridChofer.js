agrupamientoGrids = "";
primeraVez = true;
table = "/carboneria/public/index.php/administrativo/chofer/";
campos = new Array('Proveedor', 'Chofer','Fecha Nacimiento','Telefono','cod_proveedor');
camposId = new Array('desc_proveedor', 'nombre_chofer','fecha_nacimiento','telefono_chofer','cod_proveedor');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
    ...
    parametros.nombre_chofer = rowObject[3];
    parametros.fecha_nacimiento = rowObject[4];
    parametros.telefono_chofer = rowObject[5];
