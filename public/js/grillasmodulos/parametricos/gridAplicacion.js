//table = "/proyectoZend/public/index.php/parametricos/aplicacion/";
table = "/factura/proyectoZend/public/index.php/parametricos/aplicacion/";
campos = new Array('MODULO','DESCRIPCION APLICACION','ESTADO');
camposId = new Array('moduloDesc','aplicacionDesc','activo');
...
function cargarLinkModificar ( cellvalue, options, rowObject )
{
	...
	parametros.desc_aplicacion = rowObject[3];
	parametros.cod_modulo = rowObject[5];
	parametros.activo = rowObject[6];
