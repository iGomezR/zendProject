table = "/factura/proyectoZend/public/index.php/aduanas/centrocostocliente/";
//table = "/proyectoZend/public/index.php/aduanas/centrocostocliente/";
    ...
    jQuery("#grillaRegistro").jqGrid({
        ...
        "colModel":
                [
                    ...
                    {
                        "title": false,
                        "name": "cod_centro_costos_cta_cliente",
                        "label": "Codigo Centro de Costo",
                        "id": "cod_centro_costos_cta_cliente",
                        "sortable": false,
                        "width": 12,
                        "align": "right",
                        "search": false,
                    ...
                    {
                        "title": false,
                        "name": "desc_centro_costos_cta_cliente",
                        "label": "Descripcion Centro de Costo",
                        "id": "desc_centro_costos_cta_cliente",
                        "width": 90,
                        "sortable": false,
                        "align": "left",
                        "search": false,
...
//    alert(id);
    ...
    jsonObject.cod_centro_costos_cta_cliente = $("#grillaRegistro").jqGrid('getCell', id, 'cod_centro_costos_cta_cliente');
    jsonObject.desc_centro_costos_cta_cliente = $("#grillaRegistro").jqGrid('getCell', id, 'desc_centro_costos_cta_cliente');
...
function cargarLinkModificar(cellvalue, options, rowObject)
{
    ...
    parametros.cod_centro_costos_cta_cliente = rowObject[1];
    parametros.desc_centro_costos_cta_cliente = rowObject[2];
