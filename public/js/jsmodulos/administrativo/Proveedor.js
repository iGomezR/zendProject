...
table = "/administrativo/Proveedor/";
mensajeWarning = new Array(
        "Debe seleccionar una sucursal por favor",
        "Debe ingresar la descripcion del proveedor por favor",
        "Debe ingresar el RUC por favor",
        "Debe Ingresar la Direccion por favor",
        "Debe ingresa el telefono, por favor");
idCamposGrilla = new Array("id-registro","selectSucursal","desc_proveedor","ruc_proveedor","direccion_proveedor","telefono_proveedor");
...
function obtenerJsonFormulario() {
	...
	if($('#'+idCamposGrilla[1]).attr("value") == -1 || $('#'+idCamposGrilla[1]).attr("value").length == 0){
		...
		jsonObject.idRegistro = $('#'+idCamposGrilla[0]).attr("value");
                ...
                jsonObject.desc_proveedor = $('#'+idCamposGrilla[2]).attr("value");
                jsonObject.ruc_proveedor = $('#'+idCamposGrilla[3]).attr("value");
                jsonObject.direccion_proveedor = $('#'+idCamposGrilla[4]).attr("value");
                jsonObject.telefono_proveedor = $('#'+idCamposGrilla[5]).attr("value");
		return jsonObject;
	}
    return null;
}
...
function editarRegistro(parametros){
	...
	$("#"+idCamposGrilla[2]).attr("value",parametros.desc_proveedor);
	$("#"+idCamposGrilla[3]).attr("value",parametros.ruc_proveedor);
        $("#"+idCamposGrilla[4]).attr("value",parametros.direccion_proveedor);
        $("#"+idCamposGrilla[5]).attr("value",parametros.telefono_proveedor);
