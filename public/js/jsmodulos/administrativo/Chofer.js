...
table = "/administrativo/Chofer/";
mensajeWarning = new Array(
        "Debe seleccionar un proveedor, por favor",
        "Debe ingresar el nombre del chofer,por favor",
        "Debe ingresar la fecha de nacimiento del chofer,por favor",
        "Debe Ingresar el telefono del chofer,por favor");
idCamposGrilla = new Array("id-registro","selectProveedor","nombre_chofer","fecha_nacimiento","telefono_chofer");

$().ready(function() {
        cargarProveedor();
        $("#"+idCamposGrilla[3]).datepicker();
        $("#"+idCamposGrilla[3]).datepicker("option", "dateFormat", "yy-mm-dd");        
...
function obtenerJsonFormulario() {
	...
	if($('#'+idCamposGrilla[1]).attr("value") == -1 || $('#'+idCamposGrilla[1]).attr("value").length == 0){
		...
		jsonObject.idRegistro = $('#'+idCamposGrilla[0]).attr("value");
                ...
                jsonObject.nombre_chofer = $('#'+idCamposGrilla[2]).attr("value");
                jsonObject.fecha_nacimiento = $('#'+idCamposGrilla[3]).attr("value");
                jsonObject.telefono_chofer = $('#'+idCamposGrilla[4]).attr("value");
		return jsonObject;
	}
    return null;
}
...
function editarRegistro(parametros){
	...
	$("#"+idCamposGrilla[2]).attr("value",parametros.nombre_chofer);
	$("#"+idCamposGrilla[3]).attr("value",parametros.fecha_nacimiento);
        $("#"+idCamposGrilla[4]).attr("value",parametros.telefono_chofer);        
