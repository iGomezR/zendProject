...
$().ready(function() {
	...
	$("#nuevoregistro").click(function() {
		...
		$("#editar-nuevo").html("Nuevo Registro"); 
                $("#labelDescuentos").html("Resultados de Analisis");
	...
	validarNumerosCampo();    
        ...
        $("#selectNro_orden_de_entrada").change(function() {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {
                        "NumeroInterno": jsonObject.cod_cargamento
                    },
                    dataType: 'json',
                    async: false,
                    success: function(respuesta) {
...
function cargamentopendientesdesalida(){
	$.ajax({
        url: table+'cargamentopendientesdesalidadata',
        type: 'post',
        dataType: 'html',
        async : false,
        success: function(respuesta){
...
function cargamentoprocesadodesalida(){
	$.ajax({
        url: table+'cargamentoprocesadodesalidadata',
        type: 'post',
        dataType: 'html',
        async : false,
        success: function(respuesta){
