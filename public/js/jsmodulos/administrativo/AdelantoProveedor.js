table = "/administrativo/AdelantoProveedor/";
mensajeWarning = new Array(
        "Debe seleccionar un proveedor, por favor",
        "Debe ingresar la fecha de adelanto,por favor",
        "Debe ingresar el monto de adelanto,por favor");
idCamposGrilla = new Array("id-registro","selectProveedor","fecha_adelanto","monto_adelanto","estado_adelanto");
...
function obtenerJsonFormulario() {
	...
	if($('#'+idCamposGrilla[1]).attr("value") == -1 || $('#'+idCamposGrilla[1]).attr("value").length == 0){
		...
		jsonObject.idRegistro = $('#'+idCamposGrilla[0]).attr("value");
                ...
                jsonObject.fecha_adelanto = $('#'+idCamposGrilla[2]).attr("value");
                jsonObject.monto_adelanto = $('#'+idCamposGrilla[3]).attr("value");
                jsonObject.estado_adelanto = $('#'+idCamposGrilla[4]).attr("value");
		return jsonObject;
	}
    return null;
}
